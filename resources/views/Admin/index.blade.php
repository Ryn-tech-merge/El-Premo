...
@section('content')
    ...
    {{--										<a href="#" class="dropdown-item"><i class="bx bxs-file-pdf ml-2"></i>Export as Pdf</a>--}}
    {{--										<a href="#" class="dropdown-item"><i class="bx bxs-file-image ml-2"></i>Export as Image</a>--}}
    {{--										<a href="#" class="dropdown-item"><i class="bx bxs-file ml-2"></i>Export as Excel</a>--}}
    {{--									</div>--}}
    {{--								</div>--}}
    {{--							</div>--}}
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/3.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                         Vashti Riccio
                                    </td>
                                    <td>#89345</td>
                                    <td>Sport Shooes</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/4.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                        Harriett Lauver
                                    </td>
                                    <td>#39281</td>
                                    <td>T-Shirt</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/5.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                        Darci Faw
                                    </td>
                                    <td>#35825</td>
                                    <td>Hand Bag</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/6.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                        Jamie Norville
                                    </td>
                                    <td>#62391</td>
                                    <td>Lather Watch</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/7.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                        Danae Kaba
                                    </td>
                                    <td>#92481</td>
                                    <td>Laptop</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{url('admin')}}/assets/images/users/8.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                        Jeromy Tricarico
                                    </td>
                                    <td>#29381</td>
                                    <td>Office Chair</td>
