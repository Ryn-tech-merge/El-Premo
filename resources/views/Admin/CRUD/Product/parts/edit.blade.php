...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('products.update',$product->id)}}">
    ...
    <div class="row mt-0">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-6 mt-0">
            ...
            <input type="text" class="form-control form-control-solid numbersOnly"  placeholder="سعر الشراء " id="purchase_price" name="purchase_price" value="{{$product->purchase_price}}"/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-6 mt-0 ">
