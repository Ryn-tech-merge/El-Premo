...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('products.update',$product->id)}}">
    ...
    <div class="row mt-0">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-6 mt-0">
            ...
            <input type="text" class="form-control form-control-solid numbersOnly change_amount" placeholder="الكمية " name="lg_sm_amount" id="lg_sm_amount"   value="{{$product->lg_sm_amount}}"/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-6 mt-0">
