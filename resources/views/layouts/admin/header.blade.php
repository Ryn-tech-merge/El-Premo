        ...
        <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                    <div class="message-menu">
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('admin')}}/assets/images/users/1.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('admin')}}/assets/images/users/12.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('admin')}}/assets/images/users/4.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('admin')}}/assets/images/users/15.jpg"></span>
                            <div>
            ...
            <div class="dropdown d-md-flex country-selector">
                <a href="#" class="d-flex nav-link icon leading-none" data-toggle="dropdown" aria-expanded="true">
                    <img src="{{url('admin')}}/assets/images/flags/us_flag.jpg" alt="img" class="ml-2 align-self-center">
                    <div>
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="{{url('admin')}}/assets/images/flags/french_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">
                        <div>
                            <strong>French</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="{{url('admin')}}/assets/images/flags/germany_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">
                        <div>
                            <strong>Germany</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="{{url('admin')}}/assets/images/flags/italy_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">
                        <div>
                            <strong>Italy</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="{{url('admin')}}/assets/images/flags/russia_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">
                        <div>
                            <strong>Russia</strong>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <img src="{{url('admin')}}/assets/images/flags/spain_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">
                        <div>
                            <strong>Spain</strong>
                        </div>
                    </a>
